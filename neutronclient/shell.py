...
COMMAND_V2 = {
    ...
    'classifier-create': grouppolicy.CreateClassifier,
    'classifier-delete': grouppolicy.DeleteClassifier,
    'classifier-update': grouppolicy.UpdateClassifier,
    'classifier-list': grouppolicy.ListClassifier,
    'classifier-show': grouppolicy.ShowClassifier,
    'action-create': grouppolicy.CreateAction,
    'action-delete': grouppolicy.DeleteAction,
    'action-update': grouppolicy.UpdateAction,
    'action-list': grouppolicy.ListAction,
    'action-show': grouppolicy.ShowAction,
}
